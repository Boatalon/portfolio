...
export const projects: Project[] = [
    ...
    },
    {
        ...
        descriptionTH: 'ระบบจัดการฟาร์มโคนมอัจฉริยะผ่าน IoT และการวิเคราะห์ข้อมูลเพื่อติดตามสุขภาพโค ความเครียด และสภาพแวดล้อมในฟาร์มแบบเรียลไทม์ โดยเก็บและวัดผลจากแผทผู้เชี่ยวชาญ',
        image: '/images/idairy-smartfarm.jpg',
        tags: ['IoT', 'Smart Farm', 'Data Analytics', 'Embedded Systems', 'Dashboard', 'C/C++','API'],
        featured: true,
        category: 'other',
        layout: 'demo-right',
