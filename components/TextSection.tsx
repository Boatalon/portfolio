    ...
    return (
        <div className="bg-white border border-gray-300 rounded-2xl p-4 lg:p-6 h-full flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
                ...
                {/* Technologies */}
                <div className="mb-6">
                    <h4 className="text-base lg:text-lg font-semibold text-gray-900 mb-3">Technologies</h4>
                    <div className="flex flex-wrap gap-2">
                        {project.tags.map((tag, index) => (
                            <motion.span
                                ...
                                className="px-2.5 py-1 glass-effect border border-amber-600/20 text-gray-800 text-xs lg:text-sm rounded-full font-medium hover:border-amber-600/60 hover:shadow-md transition-all"
                            >
                                {tag}
                            </motion.span>
                        ))}
                ...
                {project.features && project.features.length > 0 && (
                    <div>
                        <h4 className="text-base lg:text-lg font-semibold text-gray-900 mb-3">Key Features</h4>
